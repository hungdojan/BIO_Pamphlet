...
\begin{document}
    ...
    \begin{figure*}[ht]
        \begin{center}
            \includegraphics[width=0.75\textwidth]{bsn.png}
        \end{center}
    ...
    Podobně jako u ostatních metod, i v tomto případě byla chybná identifikace zaviněna nesprávnou detekcí optického disku.
